...
exports.CertificateReviewServer = exports.ServerEvent = void 0;
...
(function (ServerEvent) {
    ServerEvent["APPROVED"] = "approved";
    ServerEvent["CANCELLED"] = "cancelled";
    ServerEvent["TIMEOUT"] = "timeout";
 ...
 */
class CertificateReviewServer extends events_1.EventEmitter {
    constructor() {
        super(...arguments);
        this.server = null;
     ...
     */
    async start(certificateUrl, companyName) {
        if (this.isRunning) {
     ...
     */
    handleRequest(req, res, certificateUrl, companyName) {
        const url = req.url || '/';
     ...
     */
    serveMainPage(res, certificateUrl, companyName) {
     ...
     */
    generateHtml(certificateUrl, companyName) {
        return `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
exports.CertificateReviewServer = CertificateReviewServer;
